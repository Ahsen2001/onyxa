...
@php
    $palette = match ($status) {
        'published', 'active', 'available', 'upcoming', 'replied' => 'bg-brand-green/10 text-brand-green',
        'draft', 'made_to_order', 'new', 'unread' => 'bg-brand-gold/15 text-[#8A641E]',
        'inactive', 'cancelled', 'out_of_stock' => 'bg-red-50 text-red-700',
        'completed', 'read', 'closed' => 'bg-slate-100 text-slate-700',
