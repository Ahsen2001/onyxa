...
@section('content')
    <section class="bg-[#2E7D32] py-20 text-white">
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 text-lg leading-8 text-white/80">{!! rich_text(page_section('sustainability', 'sustainability', 'content', 'ONYXA transforms natural coconut shells into lasting handmade products, reducing waste and celebrating renewable material use.')) !!}</div>
        </div>
    </section>
@endsection
