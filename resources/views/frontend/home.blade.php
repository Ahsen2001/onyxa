    ...
    <section class="relative overflow-hidden bg-[#FFF8EC]">
        ...
        <div class="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-24">
            <div class="relative">
                ...
                <div class="mt-6 max-w-2xl text-lg leading-8 text-[#5F584F]">
                    {!! rich_text(page_section('home', 'introduction', 'content', 'We transform coconut shells into refined handmade pieces that bring natural warmth, practical beauty, and sustainable craftsmanship into modern spaces.')) !!}
                </div>
